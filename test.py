...
from regexx import RegexTokenizer
...
test_strings = [
    "", # empty string
    "?", # single character
    "hello world!!!? (안녕하세요!こんにちは你好) lol123 😉🐸👍🏽👨‍👩‍👧‍👦✨", # fun small string
    "     \t\n      ",
    " I can't, won't, shouldn't've done that.",  #  Contractions + Apostrophes
    "\u0000\u0001\u0002\n\r",   # control characters.
    "aaaaaaaaaaaaaaaaaaaaaaaaaa",
    "هذا الشيء هو رمزي المميز",
    "abcdabcd",
    chr(0x1F91D) + chr(0x1F4AF),
...
specials_string = """
    <|endoftext|>Hello world this is one document,بۇ شىكايەت مېنىڭ بەلگە
...
def test_encode_decode_identity(tokenizer_factory, text):
    ...
    if isinstance(tokenizer, (GPT4Tokenizer, RegexTokenizer)):
...
#  (venv) goku@akira:~/Documents/PYTHON/minbpe$ pytest -v test.py
# for making this shit works, run that command from corresponding directory.
