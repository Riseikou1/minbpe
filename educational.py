...
def bpe_train(
    ...
    while len(ranks) < vocab_size:
        ...
        if visualise:
            ...
            if visualise in ["colour", "color"]:
                print("How some words in our training data look like? :")
                visualise_tokens([token for word in words[300:580] for token in word])
            elif visualise == "simple":
...
def train_simple_encoding(file=None):
    gpt2_pattern = (
    ...
    #data = "hello world! this is a simple test string to train our BPE tokenizer. let's see how it works."

    enc = SimpleBytePairEncoding.train(data, vocab_size=6000, pat_str=gpt2_pattern)
...
train_simple_encoding("taylorswift.txt")
